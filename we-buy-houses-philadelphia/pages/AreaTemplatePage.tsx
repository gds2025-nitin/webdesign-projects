...
const AreaTemplatePage: React.FC<AreaTemplatePageProps> = ({ area }) => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link
                to="/"
                className="bg-[#FB8500] text-white px-10 py-5 rounded-2xl font-black text-xl shadow-xl shadow-[#FB8500]/20 hover:bg-[#FFB703] transition-all flex items-center group inline-flex"
              >
