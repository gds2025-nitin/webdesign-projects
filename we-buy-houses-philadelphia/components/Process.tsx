...
const StepCard = ({ step, index, onNavigate }: { step: any; index: number; onNavigate: any }) => {
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button 
                ...
                className="w-full sm:w-auto bg-[#FB8500] text-white px-10 py-5 rounded-2xl font-black text-xl shadow-xl shadow-orange-600/20 hover:bg-[#FFB703] transition-all active:scale-95"
              >
                GET YOUR CASH OFFER
              </button>
              <button 
                onClick={() => onNavigate('how-it-works')}
                className="w-full sm:w-auto px-10 py-5 rounded-2xl text-[#023047] font-black text-xl border-2 border-slate-200 hover:bg-slate-50 transition-all"
              >
                Detailed Process
              </button>
            </div>
